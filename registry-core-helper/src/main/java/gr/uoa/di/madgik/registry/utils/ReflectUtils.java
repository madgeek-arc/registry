...
package gr.uoa.di.madgik.registry.utils;
...
public class ReflectUtils {
    ...
    public static String getId(@NotNull Class<?> clazz, @NotNull Object resource) throws InvocationTargetException {
        String id = null;
        try {
    ...
    private static String getIdField(@NotNull Class<?> clazz, @NotNull Object resource) {
        String id = null;
        try {
            Field idField = clazz.getDeclaredField("id");
            idField.setAccessible(true);
